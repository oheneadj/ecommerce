...
/**
 * An SMS provider the Super Admin can activate from Store Settings.
 * Adding a new provider still means a new driver class + a config/sms.php
...
enum SmsProvider: string implements HasLabel
{
    ...
    {
        $credentials = (array) config("sms.providers.{$this->value}", []);
