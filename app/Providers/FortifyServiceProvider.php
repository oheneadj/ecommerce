...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureActions(): void
    {
        ...
        // (User::canAccessPanel()) — a disabled customer account could
        // still log in with a valid password with no effect at all.
        // Fortify's own documented extension point for exactly this kind
        // of extra credential constraint — the rest of its pipeline
        // (throttling, 2FA challenge, session creation) still runs
        // unchanged around this callback.
        Fortify::authenticateUsing(function (Request $request): ?User {
            ...
            if ($user->disabled_at !== null) {
                throw ValidationException::withMessages([
                    Fortify::username() => __('This account has been disabled. Please contact support.'),
                ]);
            }
