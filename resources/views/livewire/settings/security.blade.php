<section class="w-full">
                    ...
                    <div class="flex flex-col items-center space-y-4">
                        <div class="p-0.5 w-auto rounded-full border border-stone-100 bg-white shadow-sm">
                            <div class="p-2.5 rounded-full border border-stone-200 overflow-hidden bg-stone-100 relative">
                                ...
                                <x-app-icon name="qr-code" class="relative z-20"/>
                            </div>
                        </div>

                        <div class="space-y-2 text-center">
                            <h2 class="text-lg font-semibold text-zinc-900">{{ $this->modalConfig['title'] }}</h2>
                            ...
                            <div class="flex items-center justify-between p-4 {{ ! $loop->last ? 'border-b border-zinc-200' : '' }}">
                                <div class="flex items-center gap-4">
                                    <div class="flex size-10 shrink-0 items-center justify-center rounded-xl bg-zinc-100">
                                        <x-app-icon name="key" class="size-5 text-zinc-500" />
                                    </div>
                                    <div class="space-y-1">
                        ...
                        @empty
                            <div class="p-8 text-center">
                                <div class="mx-auto mb-4 flex size-14 items-center justify-center rounded-2xl bg-zinc-100">
                                    <x-app-icon name="key" class="size-7 text-zinc-400" />
                                </div>
                                <p class="font-medium">{{ __('No passkeys yet') }}</p>
                                <p class="mt-1 text-sm text-zinc-500">{{ __('Add a passkey to sign in without a password') }}</p>
                            </div>
                        @endforelse
                    </div>
    ...
    >
        <div class="space-y-6">
            <div class="space-y-2">
                <h2 class="text-lg font-semibold text-zinc-900">{{ __('Remove passkey') }}</h2>
                <p class="text-sm text-zinc-500">
